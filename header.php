...
<body>
    ...
    <header class="bb-header relative z-[5] border-b-[1px] border-solid border-[#eee]">
        <div class="top-header bg-[#001531] py-[6px] max-[991px]:hidden">
                        ...
                        <div class="inner-top-header flex justify-between">
                            ...
                            <div class="col-right-bar flex">
                                <div class="cols px-[12px]">
                                    <a href="faq.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins text-[14px] text-[#fff] font-light leading-[28px] tracking-[0.03rem]">Contact Us</a>
                                </div>
                                <div class="cols px-[12px]">
                                    <div class="custom-dropdown relative z-50">
                                        ...
                                        <ul class="dropdown transition-all duration-[0.3s] ease-in-out min-w-[150px] py-[10px] px-[10px] mt-[25px] absolute z-[16] text-left opacity-[0] invisible left-[0] right-[auto] bg-[#fff] block border-[1px] border-solid border-[#eee] block rounded-[10px]">
                                            ...
                                            <li class="font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem]"><a href="javascript:void(0)" class="transition-all duration-[0.3s] ease-in-out text-[13px] text-[#686e7d] hover:text-[#6c7fd8] font-normal font-Poppins py-[12px] block leading-[28px] tracking-[0.03rem]">Bangla</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- <div class="cols px-[12px]">
                        ...
                        <div class="inner-bottom-header flex justify-between max-[767px]:flex-col">
                            <div class="cols bb-logo-detail flex max-[767px]:justify-between">
                                ...
                                <div class="header-logo flex items-center max-[575px]:justify-center">
                                    <a href="index.html">
                                        <img src="assets/img/logo/logo.png" alt="logo" class="light w-[112px] max-[991px]:w-[112px] block">
                                        <img src="assets/img/logo/logo.png" alt="logo" class="dark w-[112px] max-[991px]:w-[112px] hidden">
                                    </a>
                                </div>
                                <!-- Header Logo End -->
                                        ...
                                        <div class="inner-select border-r-[1px] border-solid border-[#eee] h-full px-[20px] flex items-center absolute top-[0] left-[0] max-[991px]:hidden">
                                            <div class="custom-select w-[100px] capitalize text-[#777] flex items-center justify-between transition-all duration-[0.2s] ease-in text-[14px] relative">
                                                <select>
                                                    ...
                                                    <option value="option2">Air Conditioner</option>
                                                    <option value="option3">Computer</option>
                                                    <option value="option4">Mobile</option>
                                                    <option value="option4">Television</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="mega-menu min-w-full transition-all duration-[0.3s] ease-in-out mt-[25px] pl-[30px] absolute top-[40px] z-[16] text-left opacity-[0] invisible left-[0] right-[auto] bg-[#fff] border-[1px] border-solid border-[#eee] flex flex-col rounded-[10px]">
                                            <li class="m-[0] flex items-center">
                                                <ul class="mega-block w-[calc(25%-30px)] mr-[30px] py-[15px]">
                                                    <li class="flex items-center leading-[28px]"><a href="shop-left-sidebar-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Refrigerator & Freezer</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-left-sidebar-col-4.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Air Conditioner</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-right-sidebar-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Mobile</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-right-sidebar-col-4.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Computer</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">E-Bike</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">PCB</a></li>
                                                </ul>
                                                <ul class="mega-block w-[calc(25%-30px)] mr-[30px] py-[15px]">
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-left-sidebar-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Microwave and Electric Oven</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-left-sidebar-col-4.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Blender and Mixer Grinder</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-right-sidebar-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Washing Machine</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-right-sidebar-col-4.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Water Heater (Geyser)</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-full-width.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Home Appliances</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-full-width.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Hardware Items</a></li>
                                                </ul>
                                                <ul class="mega-block w-[calc(25%-30px)] mr-[30px] py-[15px]">
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Kitchen Appliances</a> </li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width-col-4.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Fan</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width-col-5.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">LED Light</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-full-width-col-6.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Electrical Accessories</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-banner-full-width-col-3.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Cables</a></li>
                                                </ul>
                                                <ul class="mega-block w-[calc(25%-30px)] mr-[30px] py-[15px]">
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-left-sidebar.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Lift</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-right-sidebar.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Compressor</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-banner-left-sidebar.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Battery</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-banner-right-sidebar.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Hardware & Sanitary Solutions</a></li>
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-full-col-2.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">Industrial Solutions</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
