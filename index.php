                                ...
                                <div class="flex flex-wrap w-full mb-[-24px]">
                                    ...
                                    <div class="min-[992px]:w-[50%] w-full px-[12px] min-[992px]:order-2 order-1 mb-[24px]">
                                        <div class="hero-image pr-[50px] relative max-[991px]:px-[50px] max-[575px]:px-[30px] flex justify-center max-[420px]:p-[0]">
                                            <img src="assets/img/hero/all-product-group.png" alt="hero" class="w-full pb-[50px] opacity-[1] max-[1199px]:pr-[30px] max-[991px]:pr-[0] max-[575px]:pb-[30px] max-[420px]:pb-[15px]">
            ...
            <div class="flex flex-wrap w-full mb-[-24px]">
                <div class="min-[992px]:w-[41.66%] w-full px-[12px] mb-[24px]">
                    <div class="bb-category-img relative max-[991px]:hidden">
                        <img src="assets/img/category/jaya-ahsan.png" alt="category" class="w-full rounded-[30px]">
                    ...
                    <div class="bb-category-contact max-[991px]:mt-[-24px]">
                        ...
                        <div class="bb-category-block owl-carousel ml-[-150px] w-[calc(100%+150px)] pt-[30px] pl-[30px] bg-[#fff] rounded-tl-[30px] relative max-[991px]:ml-[0] max-[991px]:w-full max-[991px]:p-[0]">
                            ...
                            <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-2 bg-[#e1fcf2]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="400">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/category/icon/air-conditioner-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Air-Conditioner</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="600">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/category/desktop-computer.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Computer</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-4 bg-[#fbf9e4]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="800">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/category/icon/mobile-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Mobile</a></h5>
                                </div>
                            </div>
                             <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="600">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/category/icon/television-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Television</a></h5>
                                </div>
                            </div>
                             <div class="bb-category-box py-[30px] px-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-1 bg-[#fef1f1]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="200">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/category/icon/hap-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Home Appliances</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-2 bg-[#e1fcf2]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="400">
                                <div class="category-image mb-[12px]">
                    ...
                    <div class="bb-vendors-img sticky top-[0]">
                        <div class="tab-content">
                            <div class="tab-vendors-pane" id="vendors_tab_one">
                                ...
                                <img src="assets/img/category/banner/refrigerator/no-frost-category-banner.jpg" alt="vendors-img-1" class="w-full rounded-[30px] border-[1px] border-solid border-[#eee]">
                                <div class="vendors-local-shape absolute bottom-[0] right-[0] h-[120px] w-[120px] bg-[#fff] pt-[20px] pl-[20px] rounded-tl-[30px]">
                                    ...
                                    <img src="assets/img/category/icon/refrigerator/no-frost-small-cat.png" alt="vendor" class="w-[100px] h-[100px] rounded-[30px] border-[1px] border-solid border-[#eee] bg-[#E6E6E6]">
                                </div>
                            </div>
                            <div class="tab-vendors-pane" id="vendors_tab_two">
                                ...
                                <img src="assets/img/category/banner/refrigerator/frost-category-banner.jpg" alt="vendors-img-2" class="w-full rounded-[30px] border-[1px] border-solid border-[#eee]">
                                <div class="vendors-local-shape absolute bottom-[0] right-[0] h-[120px] w-[120px] bg-[#fff] pt-[20px] pl-[20px] rounded-tl-[30px]">
                                    <div class="inner-shape relative"></div>
                                    <img src="assets/img/category/icon/refrigerator/frost-small-cat.png" alt="vendor" class="w-[100px] h-[100px] rounded-[30px] border-[1px] border-solid border-[#eee] bg-[#E6E6E6]">
                                </div>
                            </div>
                            <div class="tab-vendors-pane" id="vendors_tab_three">
                                ...
                                <img src="assets/img/category/banner/refrigerator/freezer-category-banner.jpg" alt="vendors-img-3" class="w-full rounded-[30px] border-[1px] border-solid border-[#eee]">
                                <div class="vendors-local-shape absolute bottom-[0] right-[0] h-[120px] w-[120px] bg-[#fff] pt-[20px] pl-[20px] rounded-tl-[30px]">
                                    <div class="inner-shape relative"></div>
                                    <img src="assets/img/category/icon/refrigerator/freezer-small-cat.png" alt="vendor" class="w-[100px] h-[100px] rounded-[30px] border-[1px] border-solid border-[#eee] bg-[#E6E6E6]">
                                </div>
                            </div>
                            <div class="tab-vendors-pane" id="vendors_tab_four">
                                ...
                                <img src="assets/img/category/banner/refrigerator/bv-category-banner.jpg" alt="vendors-img-4" class="w-full rounded-[30px] border-[1px] border-solid border-[#eee]">
                                <div class="vendors-local-shape absolute bottom-[0] right-[0] h-[120px] w-[120px] bg-[#fff] pt-[20px] pl-[20px] rounded-tl-[30px]">
                                    <div class="inner-shape relative"></div>
                                    <img src="assets/img/category/icon/refrigerator/bv-small-cat.png" alt="vendor" class="w-[100px] h-[100px] rounded-[30px] border-[1px] border-solid border-[#eee] bg-[#E6E6E6]">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="bb-vendors-tab-nav flex flex-wrap mb-[-24px]" id="vendorstab">
                                        ...
                                        <a href="#vendors_tab_one">
                                            <div class="flex items-center">
                                                <div class="bg-[#EEEEEE] border-[1px] border-solid border-[#eee] rounded-[15px] w-[90px] h-[90px] flex justify-center items-center mr-[15px] max-[420px]:mb-[10px] p-[5px]">
                                                    <img src="assets/img/category/icon/refrigerator/no-frsot-icon.png" alt="">
                                                </div>
                        ...
                        <div class="nav-item w-full mb-[24px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="bb-vendors-box bg-[#f8f8fb] border-[1px] border-solid border-[#eee] rounded-[30px] p-[10px]">
                                <div class="inner-heading flex justify-between items-center max-[420px]:flex-col">
                                    <li class="nav-link block group">
                                        <a href="#vendors_tab_two">
                                            <div class="flex items-center">
                                                <div class="bg-[#EEEEEE] border-[1px] border-solid border-[#eee] rounded-[15px] w-[90px] h-[90px] flex justify-center items-center mr-[15px] max-[420px]:mb-[10px] p-[5px]">
                                                    <img src="assets/img/category/icon/refrigerator/direct-cool-icon.png" alt="">
                                                </div>
                                                <h5 class="font-quicksand text-[18px] font-bold tracking-[0.03rem] leading-[1.2] text-[#3d4750]  group-[.active]:text-[#6c7fd8] transition-colors">
                        ...
                        <div class="nav-item w-full mb-[24px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="bb-vendors-box bg-[#f8f8fb] border-[1px] border-solid border-[#eee] rounded-[30px] p-[10px]">
                                <div class="inner-heading flex justify-between items-center max-[420px]:flex-col">
                                    <li class="nav-link block group">
                                        <a href="#vendors_tab_three">
                                            <div class="flex items-center">
                                                <div class="bg-[#EEEEEE] border-[1px] border-solid border-[#eee] rounded-[15px] w-[90px] h-[90px] flex justify-center items-center mr-[15px] max-[420px]:mb-[10px] p-[5px]">
                                                    <img src="assets/img/category/icon/refrigerator/freezer-icon.png" alt="">
                                                </div>
                                                <h5 class="font-quicksand text-[18px] font-bold tracking-[0.03rem] leading-[1.2] text-[#3d4750]  group-[.active]:text-[#6c7fd8] transition-colors">
                                                    Freezer
                                                </h5>
                        ...
                        <div class="nav-item w-full mb-[24px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="bb-vendors-box bg-[#f8f8fb] border-[1px] border-solid border-[#eee] rounded-[30px] p-[10px]">
                                <div class="inner-heading flex justify-between items-center max-[420px]:flex-col">
                                    <li class="nav-link block group">
                                        <a href="#vendors_tab_four">
                                            <div class="flex items-center">
                                                <div class="bg-[#EEEEEE] border-[1px] border-solid border-[#eee] rounded-[15px] w-[90px] h-[90px] flex justify-center items-center mr-[15px] max-[420px]:mb-[10px] p-[5px]">
                                                    <img src="assets/img/category/icon/refrigerator/baberage-cooler-icon.png" alt="">
                                                </div>
                                                <h5 class="font-quicksand text-[18px] font-bold tracking-[0.03rem] leading-[1.2] text-[#3d4750]  group-[.active]:text-[#6c7fd8] transition-colors">
                                                    Beverage Cooler
                                                </h5>
                                    ...
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/computer/desktop-category.png" alt="product-1">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/computer/desktop-category.png" alt="product-1">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Desktop</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/computer/laptop-category.png" alt="product-2">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/computer/laptop-category.png"
                                                    alt="product-2">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Laptop</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/computer/monitor-category.png" alt="product-3">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/computer/monitor-category.png"
                                                    alt="product-3">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Monitor</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/computer/keyboard-category.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/computer/keyboard-category.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Keyboard</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
...
<!-- Mobile Banner-->
                            ...
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/mobile/xanon-x1-ultra.png" alt="product-1">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/mobile/xanon-x1-ultra.png" alt="product-1">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">XANON</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/mobile/nexg-n75.png" alt="product-2">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/mobile/nexg-n75.png"
                                                    alt="product-2">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">NEXG</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/mobile/zenx-2.png" alt="product-3">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/mobile/zenx-2.png"
                                                    alt="product-3">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">ZENX</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/mobile/orbit-y70.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/mobile/orbit-y70.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">ORBIT</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/mobile/axion.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/mobile/axion.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">AXION</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- TV Banner-->
     <section class="section-banner-two overflow-hidden my-[50px] max-[1199px]:my-[35px] bg-[url('assets/img/category/banner/television/tv-bg.jpg')] min-h-[770px] overflow-hidden bg-no-repeat bg-cover bg-center max-[991px]:min-h-[auto]">
        <div class="flex flex-wrap justify-between relative items-center mx-auto min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
                <div class="w-full lg:h-[770px] flex flex-col lg:flex-row items-center max-[991px]:min-h-[auto] p-3 lg:p-0">
                    ...
                    <div class="lg:w-3/5 w-full">
                         <div class="text-white mb-[30px]">
                            <h2 class="text-3xl font-semibold">Television</h2>
                            <p class="text-gray-300">Welcome to the world of WALTON’s modern and user-friendly 4K, Smart, LED TV</p>
                            <div class="h-[2px] w-full bg-blue-500 mx-auto mt-2"></div>
                        </div>
                        <div class="flex flex-wrap lg:flex-nowrap w-full justify-center items-center gap-4">
                            <div class="w-full lg:w-1/2 h-[450px] bg-white/50 flex flex-col justify-start items-start rounded-lg p-[40px] text-white">
                                <p class="text-2xl font-semibold uppercase tracking-wide">TV</p>
                                <h2 class="text-2xl font-semibold">W6556DG</h2>
                                <img src="assets/img/category/banner/television/W6556DG.png" alt="Smart TV" class="rounded-xl w-full" />
                            </div>
    ...
    <section class="section-category overflow-hidden py-[50px] max-[1199px]:py-[35px]">
        <div class="flex flex-wrap justify-between relative items-center mx-auto min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full mb-[-24px]">
                <div class="min-[992px]:w-[41.66%] w-full px-[12px] mb-[24px]">
                    <div class="bb-category-img relative max-[991px]:hidden">
                        <img src="assets/img/category/banner/hap/hap-category-banner.jpg" alt="category" class="w-full rounded-[30px]">
                    </div>
                </div>
                <div class="min-[992px]:w-[58.33%] w-full px-[12px] mb-[24px]">
                    <div class="bb-category-contact max-[991px]:mt-[-24px]">
                        ...
                        <div class="bb-category-block owl-carousel ml-[-150px] w-[calc(100%+150px)] pt-[30px] pl-[30px] bg-[#fff] rounded-tl-[30px] relative max-[991px]:ml-[0] max-[991px]:w-full max-[991px]:p-[0]">
                            <div class="bb-category-box px-[10px] py-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-1 bg-[#fef1f1]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="200">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/product/hap/blender-category.png" alt="category" class="w-[80px] h-[80px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Blender</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box px-[10px] py-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-2 bg-[#e1fcf2]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="400">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/product/hap/gas-stove-category.png" alt="category" class="w-[80px] h-[80px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Gas Stove</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box px-[10px] py-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="600">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/product/hap/oven-category.png" alt="category" class="w-[80px] h-[80px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Oven</a></h5>
                                </div>
                            </div>
                            <div class="bb-category-box px-[10px] py-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-4 bg-[#fbf9e4]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="800">
                                <div class="category-image mb-[12px]">
                                    <img src="assets/img/product/hap/rice-cooker-category.png" alt="category" class="w-[80px] h-[80px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                </div>
                                <div class="category-sub-contact">
                                    <h5 class="mb-[2px] text-[16px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[16px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Rice Cooker</a></h5>
                                </div>
                            </div>
                             <!-- <div class="bb-category-box p-[30px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]" data-aos="flip-left" data-aos-duration="1000" data-aos-delay="600">
                                <div class="category-image mb-[12px]">
    ...
    <!-- Cable Banner-->
    <section class="section-banner-two overflow-hidden my-[50px] max-[1199px]:my-[35px] bg-[url('assets/img/category/banner/cable/cable-category-banner.jpg')] min-h-[600px] overflow-hidden bg-no-repeat bg-cover bg-center max-[991px]:max-h-[400px] max-[991px]:min-h-[auto]">
        <div class="flex flex-wrap justify-between relative items-center mx-auto min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full">
                            ...
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/category/banner/cable/Medium-Voltage-Cable-(MV).png" alt="product-1">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/category/banner/cable/Medium-Voltage-Cable-(MV).png" alt="product-1">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Medium-Voltage-Cable-(MV)</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/category/banner/cable/Communication-Cable.png" alt="product-2">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/category/banner/cable/Communication-Cable.png"
                                                    alt="product-2">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Communication</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/category/banner/cable/DC-CABLE.png" alt="product-3">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/category/banner/cable/DC-CABLE.png"
                                                    alt="product-3">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">DC-CABLE</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/category/banner/cable/SUBMERSIBLE-CABLE.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/category/banner/cable/SUBMERSIBLE-CABLE.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">SUBMERSIBLE-CABLE</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/category/banner/cable/USB-CABLE.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/category/banner/cable/USB-CABLE.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">USB-CABLE</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/eap/fan-category.png" alt="product-1">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/eap/fan-category.png" alt="product-1">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Fan</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/eap/light-category.png" alt="product-2">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/eap/light-category.png"
                                                    alt="product-2">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">LED LIGHT</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/eap/switch-socket-category.png" alt="product-3">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/eap/switch-socket-category.png"
                                                    alt="product-3">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Switch Socket</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            <div class="bb-deal-card p-[12px]" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                                                <img class="main-img transition-all duration-[0.3s] ease-in-out w-full" src="assets/img/product/eap/accessories-category.png" alt="product-4">
                                                <img class="hover-img transition-all duration-[0.3s] ease-in-out absolute z-[2] top-[0] left-[0] opacity-[0] w-full" src="assets/img/product/eap/accessories-category.png"
                                                    alt="product-4">
                                            </div>
                                        </a>
                                    </div>
                                    <div class="bb-pro-contact p-[20px]">
                                        <h4 class="bb-pro-title mb-[8px] text-[16px] leading-[18px]">
                                            <a href="" class="text-center transition-all duration-[0.3s] ease-in-out font-quicksand w-full block whitespace-nowrap overflow-hidden text-ellipsis text-[15px] leading-[18px] text-[#3d4750] font-semibold tracking-[0.03rem]">Electrical Accessories</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
      ...
      <div class="flex flex-wrap w-full">
         <div class="w-full px-[12px]">
            <!-- <div class="bb-title m-[auto] py-[15px] px-[30px] bg-[#fff] rounded-[30px] absolute top-[50%] left-[50%] z-[5] max-[991px]:py-[8px] max-[991px]:px-[20px]">
               <h3 class="font-quicksand m-[0] text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2] text-[28px] max-[991px]:text-[25px]">#Accreditation</h3>
            </div> -->
            ...
            <div class="min-[768px]:w-[41.66%] w-full px-[12px] max-[767px]:hidden">
                <div class="bb-top-contact">
                    <div class="bb-cart-title w-full mb-[20px] flex flex-wrap justify-between">
                        <h4 class="font-quicksand text-[18px] font-extrabold tracking-[0.03rem] leading-[1.2]">Related Items</h4>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap w-full mb-[-24px]">
                    ...
                    <div class="w-full">
                        <div class="flex flex-wrap w-full">
                            <div class="w-full px-[12px]">
                                <div class="sub-title mb-[20px] flex justify-between">
                                    <h4 class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[20px] font-bold text-[#3d4750] capitalize">Recent Browse Categories</h4>
                                </div>
                            </div>
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-1 bg-[#fef1f1]">
                                    <div class="category-image mb-[12px]">
                                        <img src="assets/img/category/icon/refrigerator-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                    </div>
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Refrigerator</a></h5>
                                        <!-- <p class="font-Poppins text-[13px] text-[#686e7d] leading-[25px] font-light tracking-[0.03rem]">485 items</p> -->
                                    </div>
                                </div>
                            </div>
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-2 bg-[#e1fcf2]">
                                    <div class="category-image mb-[12px]">
                                        <img src="assets/img/category/icon/eap-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                    </div>
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Fan</a></h5>
                                        <!-- <p class="font-Poppins text-[13px] text-[#686e7d] leading-[25px] font-light tracking-[0.03rem]">291 items</p> -->
                                    </div>
                                </div>
                            </div>
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]">
                                    <div class="category-image mb-[12px]">
                                        <img src="assets/img/category/icon/air-conditioner-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                    </div>
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Air Conditioner</a></h5>
                                        <!-- <p class="font-Poppins text-[13px] text-[#686e7d] leading-[25px] font-light tracking-[0.03rem]">49 items</p> -->
                                    </div>
                                </div>
                            </div>
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-4 bg-[#fbf9e4]">
                                    <div class="category-image mb-[12px]">
                                        <img src="assets/img/category/icon/mobile-icon.svg" alt="category" class="w-[50px] h-[50px] max-[1399px]:h-[65px] max-[1399px]:w-[65px] max-[1199px]:h-[50px] max-[1199px]:w-[50px]">
                                    </div>
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Smart Phone</a></h5>
                            ...
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-2 bg-[#e1fcf2]">
                                    ...
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">HAP</a></h5>
                                        <!-- <p class="font-Poppins text-[13px] text-[#686e7d] leading-[25px] font-light tracking-[0.03rem]">291 items</p> -->
                                    </div>
                                </div>
                            </div>
                            <div class="min-[1200px]:w-[16.66%] min-[768px]:w-[33.33%] min-[576px]:w-[50%] w-full px-[12px] mb-[24px]">
                                <div class="bb-category-box p-[10px] rounded-[20px] flex flex-col items-center text-center max-[1399px]:p-[20px] category-items-3 bg-[#f4f1fe]">
                                    ...
                                    <div class="category-sub-contact">
                                        <h5 class="mb-[2px] text-[14px] font-quicksand text-[#3d4750] font-semibold tracking-[0.03rem] leading-[1.2]"><a href="shop-left-sidebar-col-3.html" class="font-Poppins text-[14px] font-medium leading-[1.2] tracking-[0.03rem] text-[#3d4750] capitalize">Television</a></h5>
                                        <!-- <p class="font-Poppins text-[13px] text-[#686e7d] leading-[25px] font-light tracking-[0.03rem]">49 items</p> -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="w-full">
                        <div class="flex flex-wrap w-full">
                            <div class="w-full px-[12px]">
                                <div class="sub-title mb-[20px] flex justify-between">
                                    <h4 class="font-quicksand tracking-[0.03rem] leading-[1.2] text-[20px] font-bold text-[#3d4750] capitalize">Recent Browse products</h4>
                                </div>
                            </div>
